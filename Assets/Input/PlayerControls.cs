...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    private List<IInPlayActions> m_InPlayActionsCallbackInterfaces = new List<IInPlayActions>();
    ...
    public struct InPlayActions
    {
        ...
        public void AddCallbacks(IInPlayActions instance)
        {
            if (instance == null || m_Wrapper.m_InPlayActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_InPlayActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IInPlayActions instance)
        {
            @Directional.started -= instance.OnDirectional;
            @Directional.performed -= instance.OnDirectional;
            @Directional.canceled -= instance.OnDirectional;
        ...
        public void RemoveCallbacks(IInPlayActions instance)
        {
            if (m_Wrapper.m_InPlayActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IInPlayActions instance)
        {
            foreach (var item in m_Wrapper.m_InPlayActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_InPlayActionsCallbackInterfaces.Clear();
